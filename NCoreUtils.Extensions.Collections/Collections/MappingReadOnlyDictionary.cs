...
public class MappingReadOnlyDictionary<TKey, TSource, TResult>(IReadOnlyDictionary<TKey, TSource> source, Func<TSource, TResult> mapping) : IReadOnlyDictionary<TKey, TResult>
{
