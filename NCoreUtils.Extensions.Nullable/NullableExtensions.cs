...
public static class NullableExtensions
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [DebuggerStepThrough]
    public static bool Any<T>(this T? source) where T : struct => source.HasValue;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [DebuggerStepThrough]
    public static bool IsEmpty<T>(this T? source) where T : struct => !source.HasValue;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [DebuggerStepThrough]
    public static TAccumulator Aggregate<TSource, TAccumulator>(this TSource? source, TAccumulator accumulator, Func<TAccumulator, TSource, TAccumulator> fun)
        where TSource : struct
    {
        if (fun == null)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [DebuggerStepThrough]
    public static bool TryGetValue<T>(this T? source, out T value)
        where T : struct
    {
        if (source.HasValue)
        {
